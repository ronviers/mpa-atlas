...
- **[`docs/handoff_next_session.md`](docs/handoff_next_session.md)** — pending-work entry point. Single file with Open item N subsections (mpa-* family convention). See [CLAUDE.md](CLAUDE.md) §"Handoff convention" for lifecycle rules.
