...
📄 **Published paper:** *Metastable Propositional Algebra: The finite-drive deformation of Boolean structure* — the unified source of truth, [`framework/mpa_unabridged.md`](framework/mpa_unabridged.md). Open access (CC-BY-4.0): **DOI [10.5281/zenodo.20357550](https://doi.org/10.5281/zenodo.20357550)**. (The `v9_*` / `cdv1_*` files below are its source layers.)
...
- **[`framework/v9_unabridged.md`](framework/v9_unabridged.md)** — public-facing prose-and-prior-art version. Rebuilt from `v9_compressed.md` + `v9_receipts.md` periodically; allowed to lag between rebuilds; not authoritative for operational lookups. If the two files disagree, the compressed file wins.
- **[`framework/v9_receipts.md`](framework/v9_receipts.md)** — line-keyed justifications for the compressed claims. Append-only during prove-as-you-go work; the file that makes unabridged reconstruction tractable.
- **[`framework/cdv1_compressed.md`](framework/cdv1_compressed.md)** — **the operational source of truth for the Character projection.** Continuous physical economics of sustained NESS traversal: chit unit, universal two-mode kernel, heat-tax tower, gFDR signatures, five leading-order posits, eleven cross-register identities. Claim-only; substrate-neutral. Companion to v9 compressed.
- **[`framework/cdv1_unabridged.md`](framework/cdv1_unabridged.md)** — public-facing prose-and-prior-art version of the Character projection. Rebuilt from `cdv1_compressed.md` + `cdv1_receipts.md` periodically; allowed to lag between rebuilds; not authoritative for operational lookups. If the two files disagree, the compressed file wins.
- **[`framework/cdv1_receipts.md`](framework/cdv1_receipts.md)** — line-keyed justifications for the cdv1 compressed claims. Append-only during prove-as-you-go work.
