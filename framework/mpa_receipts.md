...
**Companion to:** [`mpa_compressed.md`](mpa_compressed.md) (unified operational source of truth).
**Status:** Live. Append-only during prove-as-you-go work. Built Phase 2 of the unification
(2026-05-23) by folding [`v9_receipts.md`](v9_receipts.md) + [`cdv1_receipts.md`](cdv1_receipts.md)
into one file under the unified section structure. The split files stay live until Phase 3's
interface + character-test gates confirm the merge; this file does not yet replace them.
...
When a session proves, derives, or composes a result that becomes a line in `mpa_compressed.md`:
...
- **Register & character-wing entries (cdv1 projection)** keep their `### §N — Concept name`
  ...
  **the concept name is the stable anchor** (the `§N` tracks the unabridged numbering, which Phase 5
  will restructure — see [`identities_restructure_spec.md`](identities_restructure_spec.md)). Future
