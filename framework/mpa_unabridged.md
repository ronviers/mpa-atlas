...
> **Status.** The source of truth for MPA — the canonical unified document, the structural and Character
> projections joined at one spine. Line-keyed justifications, derivations, and falsifier formalisations
> live in [`mpa_receipts.md`](mpa_receipts.md); the open attack front is `FALSIFICATION.md` — read it when
...
[`mpa_receipts.md`](mpa_receipts.md), each entry tagged by citation, bespoke step, verification, and open
