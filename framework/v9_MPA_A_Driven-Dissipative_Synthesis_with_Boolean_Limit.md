...
> **Status note (operational discipline):** This document is the **public-facing prose-and-prior-art version** of v9. The operational source of truth is [`v9_compressed.md`](v9_compressed.md), which is continuously maintained alongside the RFC sequence. This file is refreshed *from* the compressed version periodically; between refreshes it is allowed to lag. Protocol revisions read from the compressed file. If the two disagree, the compressed file wins.
